...
local function execute_plugins_iterator(ctx, phase)
  ...
  for plugin, configuration in plugins_iterator:iterate(phase) do
...
function Kong.access()
  ...
  local plugins_iterator = runloop.get_plugins_iterator()
  for plugin, plugin_conf in plugins_iterator:iterate("access") do
...
function Kong.handle_error()
  ...
  if not ctx.plugins then
    runloop.update_plugins_iterator()
    local plugins_iterator = runloop.get_plugins_iterator()
    for _ in plugins_iterator:iterate("content") do
